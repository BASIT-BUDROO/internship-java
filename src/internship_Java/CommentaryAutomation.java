...
public class CommentaryAutomation {
	...
	public static void main(String[] args) {
		...
		case '1':
			...
			String bowler_name = input.nextLine();
			System.out.println("Enter the batsman name");
			String batsmen_name = input.nextLine();
			deliveries.displayDeliveryDetails(bowler_name, batsmen_name);
			break;
		case '2':
			System.out.println("Enter the number of runs");
			long runs = input.nextLong();
			deliveries.displayDeliveryDetails(runs);
			break;
		}
	}
}
